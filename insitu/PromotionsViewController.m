...
{
    [self.delegate promotionsViewControllerDidFinish:self];
}
...
- (void)downloadPromocionesCategorias {
    ...
    NSString *parent_category = [prefs objectForKey:@"parent_category"];
    ...
    NSString *response = [helper readPromocionesPorCategorias:parent_category Barrio:@"1"];
