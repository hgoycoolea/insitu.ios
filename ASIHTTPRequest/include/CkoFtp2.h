...
// property getter: CommandCharset
- (NSString *)CommandCharset;

// property setter: CommandCharset
- (void)setCommandCharset: (NSString *)input;
...
// property getter: DownloadTransferRate
- (NSNumber *)DownloadTransferRate;
...
// property getter: SyncMustMatch
- (NSString *)SyncMustMatch;

// property setter: SyncMustMatch
- (void)setSyncMustMatch: (NSString *)input;

// property getter: SyncMustNotMatch
- (NSString *)SyncMustNotMatch;

// property setter: SyncMustNotMatch
- (void)setSyncMustNotMatch: (NSString *)input;

// property getter: SyncPreview
- (NSString *)SyncPreview;

// property getter: UploadTransferRate
- (NSNumber *)UploadTransferRate;
